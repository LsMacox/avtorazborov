...
namespace App\Repositories\User\Proposal;
...
class ProposalIndexRepository extends CoreRepository
{
    ...
    public function getById(int $id)
    {
        ...
        return $this->startConditions()->where('user_id', auth()->id())->findOrFail($id);
    ...
    {
        return $this->startConditions()->create(array_merge($data, ['user_id' => auth()->id(), 'city' => 'Москва', 'phone' => auth()->user()->login]));
    }
