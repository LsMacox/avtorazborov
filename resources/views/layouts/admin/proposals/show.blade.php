            ...
            <div class="row">
                ...
                <div class="col-md-3 col-xs-3 col-lg-3 block_fix_your_choice">
                    ...
                    <div class="btn_setting_proposal">
                        <div class="edit_proposal" onclick="document.location.href = '{{ route('admin.proposal.edit', $proposal->id) }}'"><a href="#">Редактировать</a></div>
                        ...
                        <div class="del_proposal">
                            ...
                            <form action="{{ route('admin.proposal.destroy', $proposal->id) }}" method="POST" id="proposal_del">
                                @csrf
                                @method('DELETE')
                            </form>
                        </div>
                ...
                <div class="col-md-8 col-xs-8 col-lg-8 d-flex">
                    <div class="communication w-100">
                        <div id="app">
                            <admin-chat-app :proposal="{{json_encode($proposal)}}" :user="{{json_encode($user)}}" :admin="{{json_encode(auth()->user())}}"></admin-chat-app>
                        </div>
                    </div>
                </div>
            </div>
