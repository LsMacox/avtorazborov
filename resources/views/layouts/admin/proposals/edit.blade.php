    ...
    <div class="content">
        <form action="{{route('admin.proposal.update', $proposal->id)}}" method="post">
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" name="mark" value="{{$proposal->mark}}" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default">
            </div>
            <div class="input-group mb-3">
                <div class="input-group-prepend">
                    <span class="input-group-text" id="inputGroup-sizing-default">Модель авто</span>
                </div>
                <input type="text" name="model" value="{{$proposal->model}}" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default">
            </div>
            <div class="input-group mb-3">
                <div class="input-group-prepend">
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" name="phone" value="{{phone_number(auth()->user()->login)}}" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default">
            </div>
            <div class="input-group mb-3">
                <div class="input-group-prepend">
                    <span class="input-group-text" id="inputGroup-sizing-default">Город</span>
                </div>
                <input type="text" name="city" value="{{$proposal->city}}" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default">
            </div>
